...
public:
    ...
    void setupUi(QDialog *adminDeleteUser)
    {
        if (adminDeleteUser->objectName().isEmpty())
            adminDeleteUser->setObjectName("adminDeleteUser");
        adminDeleteUser->resize(1204, 626);
        QPalette palette;
        ...
        adminDeleteUser->setPalette(palette);
        adminDeleteUser->setStyleSheet(QString::fromUtf8("background-color: #858D6F;"));
        layoutWidget = new QWidget(adminDeleteUser);
    ...
    void retranslateUi(QDialog *adminDeleteUser)
    {
        adminDeleteUser->setWindowTitle(QCoreApplication::translate("adminDeleteUser", "Dialog", nullptr));
    } // retranslateUi
